...
export default function SteamPanel() {
  ...
  return (
    <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
      <div className="overflow-hidden rounded-[2rem] border border-gray-200 bg-gradient-to-br from-white via-white to-blue-50/70 p-7 shadow-sm dark:border-gray-800 dark:from-gray-950 dark:via-gray-950 dark:to-blue-950/30 sm:p-10">
